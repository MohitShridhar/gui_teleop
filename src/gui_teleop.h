...
#define DEFAULT_MAX_LINEAR_VEL 3
#define DEFAULT_MAX_ANGULAR_VEL 2
...
protected Q_SLOTS:
  ...
  void setMaxLinearVel();
  void setMaxAngularVel();
  void suppressSpeed();
...
protected:
  ...
  QLineEdit* max_linear_vel_editor_; 
  QLineEdit* max_angular_vel_editor_;

  QCheckBox* pub_check_box_;
